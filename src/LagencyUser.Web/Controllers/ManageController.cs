...
using LagencyUser.Web.Models.ManageViewModels;
...
namespace LagencyUser.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public Tenant GetCurrentTenant()
        {
            ...
            return _tenantQueries.GetTenantByNameAsync("lnh").Result;
        }
        ...
        public async Task<IActionResult> Index(ManageMessageId? message = null)
        {
            ...
            {
                ManageLoginsModel = await this.GetManageLoginsModel(message),
        ...
        //[HttpGet]
        public async Task<ManageLoginsViewModel> GetManageLoginsModel(ManageMessageId? message = null)
        {
            var messages = ViewData["StatusMessage"].ToString();
