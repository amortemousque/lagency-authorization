...
namespace LagencyUser.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await _emailSender.SendEmailAsync(model.Email, _localizer["Reset Password"],
                                                  _localizer["Please reset your password by clicking here: {0}", "<a href=\"" + callbackUrl + "\">link</a>" ]);
                return View("ForgotPasswordConfirmation");
            }
        ...
        public async Task<IActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            {
                await _emailSender.SendEmailAsync(await _userManager.GetEmailAsync(user), _localizer["Security Code"], message);
            }
